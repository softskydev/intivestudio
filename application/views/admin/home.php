          ...
          <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  <h5 class="card-title">Homepage SEO</h5>
                ...
                <div class="card-body" style="display: block;">
                  <form action="<?= base_url('admin/save_seo') ?>" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="desc" class="form-control" value="<?= @$seo['desc'] ?>">
                    </div>  
                    <div class="form-group">
                      <label>Meta Keyword</label>
                      <input type="text" name="keyword" class="form-control" value="<?= @$seo['keyword'] ?>">
                    </div>
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Homepage Content</h5>
